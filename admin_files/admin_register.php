                        ...
                        <div class="col-lg-12">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">New Admin Registration</h1>
                                </div>
                                <form class="user" action="code.php" method="POST">
                                    ...
                                    <button type="submit" name="admin_register_btn" class="btn btn-primary btn-user btn-block"style="border-radius: 10rem;"> Submit </button>
                                    <hr>
                                </form>
                            </div>
                        </div>
